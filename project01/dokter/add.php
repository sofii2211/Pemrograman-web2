...
// Menggunakan metode isset untuk memeriksa apakah kunci $_POST tersedia sebelum mengakses nilainya
if (isset($_POST["submit"])) {
    ...
    // Sesuaikan jumlah parameter yang diikat dengan jumlah token dalam query
    ...
    // Gunakan try-catch untuk menangani PDOException
    try {
                        ...
                        <div class="card-body">
                            ...
                            <form action="add.php" method="POST">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-8">
                                        <input id="telpon" name="telpon" type="text" class="custom-select">
                                    </div>
                                </div>
                                <div class="form-group row">
